...
| **Measurement log** | 120 numbered findings, each declaring how it was produced |
...
- [`docs/FINDINGS.md`](docs/FINDINGS.md) — the full measurement log, numbered sequentially
  (120 entries and counting), each declaring how its numbers were produced.
...
benchmark integration at 90% coverage, and 120 numbered, provenance-tagged findings.
