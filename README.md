...
- [`docs/FINDINGS.md`](docs/FINDINGS.md) — the full measurement log, numbered sequentially
  (109 entries and counting), each declaring how its numbers were produced.
...
T4), an external benchmark integration (TabArena, `docs/TABARENA.md`, 90% coverage), and 109
