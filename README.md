...
- [`docs/FINDINGS.md`](docs/FINDINGS.md) — the full measurement log, numbered sequentially
  (84 entries and counting), each declaring how its numbers were produced.
...
T4), and 84 numbered, provenance-tagged findings. What is currently proven, currently open, and
