...
(`docs/FINDINGS.md` §3). Every vendor arrives holding excellent retrospective numbers and a
...
competitor entering next year, and `docs/LANDSCAPE.md` says every other axis favours them.
...
- **Blocked by** a licensed source of company financials with observable outcomes. Expect
  this to be the binding constraint (`docs/FINDINGS.md` §4). UK Companies House is the most
